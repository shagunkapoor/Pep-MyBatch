...
public class Kruskals {
	...
	public static ArrayList<Edge> kruskals(ArrayList<Edge> graph) {
		...
		LAug18.HashMap<String, Pair> disjoint = new LAug18.HashMap<>();
	...
	public static String find(String vtx, LAug18.HashMap<String, Pair> disjoint) {
	...
	public static void merge(String v1name, String v2name, LAug18.HashMap<String, Pair> disjoint) {
